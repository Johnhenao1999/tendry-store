      ...
      <Container>
        <FooterContent>
          <BrandSection>
            ...
            <SocialLinks>
              ...
              <SocialLink 
                href="https://facebook.com/Juan Diego Velez" 
                target="_blank" 
                rel="noopener noreferrer"
                aria-label="Facebook"
              >
              ...
              <SocialLink 
                href="https://instagram.com/tendryxstore_11" 
                target="_blank" 
                rel="noopener noreferrer"
          ...
          <FooterSection>
            <FooterTitle as="h4">Ayuda</FooterTitle>
            <FooterLinks>
              <li><FooterLink to="/preguntas-frecuentes">Preguntas Frecuentes</FooterLink></li>
              <li><FooterLink to="/envios">Envíos</FooterLink></li>
              <li><FooterLink to="/devoluciones">Devoluciones</FooterLink></li>
              <li><FooterLink to="/politica-privacidad">Política de Privacidad</FooterLink></li>
        ...
        <BottomBar>
          <Text $size="sm" $color="muted">
            © {new Date().getFullYear()} TENDRYX. Todos los derechos reservados.
          </Text>
        </BottomBar>
      </Container>
    </FooterWrapper>
